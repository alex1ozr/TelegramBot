...
internal sealed class HelpBotCommandHandler : IRequestHandler<HelpBotCommand, Unit>
{
    private readonly ITelegramBotClient _telegramBotClient;
    private readonly IBotMessageLocalizer _botMessageLocalizer;

    public HelpBotCommandHandler(
    ...
    public async Task<Unit> Handle(HelpBotCommand request, CancellationToken cancellationToken)
    {
